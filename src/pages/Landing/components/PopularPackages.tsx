...
const PACKAGE_ITEMS: PackageItem[] = [
  { id: 1, title: '스카이뷰 호텔 페키지', location: '서울 강남구', price: '₩450,000~', rating: 4.8, reviewCount: 120 },
  { id: 2, title: '프라이빗 다이닝 페키지', location: '서울 이태원', price: '₩350,000~', rating: 4.7, reviewCount: 86 },
  { id: 3, title: '감성 야외 프로포즈', location: '경기 가평', price: '₩250,000~', rating: 4.9, reviewCount: 203 },
  { id: 4, title: '비치 썬셋 프로포즈', location: '부산 해운대', price: '₩500,000~', rating: 4.6, reviewCount: 54 },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="w-full px-6 md:px-16">
        <div className="mb-10 flex flex-col justify-between gap-4 md:mb-12 md:flex-row md:items-end">
          <h2 className="text-3xl font-bold text-text md:text-4xl">인기 프로포즈 페키지</h2>
          ...
          {PACKAGE_ITEMS.map((item) => (
            ...
            >
              ...
              <div className="relative mt-auto flex flex-col gap-1 p-5">
                <p className="text-xs text-white/70">★ {item.rating.toFixed(1)} ({item.reviewCount})</p>
