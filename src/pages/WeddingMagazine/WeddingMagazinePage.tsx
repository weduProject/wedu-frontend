...
const DUMMY_POSTS: MagazinePost[] = [
  {
    ...
    category: '웨딩팁', imageUrl: img1, likes: 256, comments: 51, date: '2026년 8월 3일',
  },
  {
    id: 2,
    ...
    category: '플래너', imageUrl: img2, likes: 215, comments: 42, date: '2026년 8월 2일',
  },
  {
    id: 3,
    ...
    category: '박람회', imageUrl: img3, likes: 128, comments: 24, date: '2026년 8월 1일',
  },
  {
    id: 4,
    ...
    category: '플래너', imageUrl: img4, likes: 187, comments: 35, date: '2026년 7월 30일',
  },
  {
    id: 5,
    ...
    category: '웨딩팁', imageUrl: img5, likes: 198, comments: 39, date: '2026년 7월 29일',
  },
  {
    id: 6,
    title: '신라호텔 웨딩 페어 2026 — 영빈관 투어 후기',
    content: '지난주 다녀온 신라호텔 웨딩페어 솔직 후기입니다. 영빈관 다이닝스티홀은 정말 압도적이었어요. 천장 높이도 엄청나고 조명 연출도 최고였어요.',
    category: '박람회', imageUrl: img6, likes: 96, comments: 18, date: '2026년 7월 28일',
  },
  {
    id: 7,
    ...
    category: '웨딩팁', imageUrl: img7, likes: 173, comments: 33, date: '2026년 7월 27일',
  },
  {
    id: 8,
    title: '강남 vs 홍대 vs 종로 — 지역별 웨딩 플래너 스타일 비교',
    content: '재미있는 사실: 서울에서도 지역에 따라 웨딩플래너 스타일이 확 갈린다는 거 아시나요? 강남권 플래너는 럭셔리 호텔 웨딩 특화로 움직여요.',
    category: '플래너', imageUrl: img8, likes: 142, comments: 28, date: '2026년 7월 26일',
  },
  {
    id: 9,
    ...
    category: '박람회', imageUrl: img9, likes: 73, comments: 11, date: '2026년 7월 25일',
  },
  {
    id: 10,
    ...
    category: '웨딩팁', imageUrl: img10, likes: 164, comments: 29, date: '2026년 7월 24일',
  },
];
      ...
      <div className="max-w-5xl mx-auto px-5 md:px-8 py-8 md:py-10">
        ...
        {!loading && (
          <>
            {/* Featured post */}
            {featuredPost && (
              <Link to={`/community/${featuredPost.id}`} className="group block mb-6 md:mb-8">
